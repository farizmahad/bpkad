...
<head>
    ...
    <!--
    <link href="<?php echo base_url();?>assets/admin/css/boots trap.min.css" rel="stylesheet">
    -->
    <link href="<?php echo base_url();?>assets/admin/font-awesome/css/font-awesome.css" rel="stylesheet">

    <link href="<?php echo base_url();?>assets/admin/css/animate.css" rel="stylesheet">

    <link href="<?php echo base_url();?>assets/admin/css/style_cd.css" rel="stylesheet">
...
<section class="section-info-keuangan">
    ...
    <form method="get" action="<?php echo base_url(); ?>Front_agenda/tren">
        <div class="row justify-content-center row-legenda">
            ...
            <div class="col-3 col-sm-3 col-md-3 col-lg-4 col-xl-3" id="col-search">
                <div class="div-input-tahun">
                        ...
                        <div class="form-group"><input class="form-control form-control-sm text-tahun" name="tahun" type="text" placeholder="Dari tahun..."></div>
...
<section class="section-info-keuangan">
    <div class="container">
        <div class="div-heading-info-keuangan" style="margin-top:50px;">
            <h2 class="text-center">Grafik Anggaran Pendapatan Daerah Tahun ... - ...</h2>
        </div>
        <div class="row justify-content-center" style="padding-bottom:30px;">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" data-aos="fade-up" data-aos-delay="200" style="padding-top:47px;">
                ...
                <div class="btn-heading">
                    <h6 class="text-center">&lt;Pake Tabel&gt;</h6>
                </div>
            </div>
        </div>
    </div>
...
<section class="section-info-keuangan">
    <div class="container">
        <div class="div-heading-info-keuangan" style="margin-top:50px;">
            <h2 class="text-center">Grafik Anggaran Belanja Daerah Tahun ... - ...<br></h2>
        </div>
        <div class="row justify-content-center" style="padding-bottom:30px;">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" data-aos="fade-up" data-aos-delay="200" style="padding-top:47px;">
...
<script src="<?php echo base_url();?>assets/admin/js/demo/flot-demo.js"></script>
-->
<script>
    //Flot Bar Chart
    $(function() {
...
<?php foreach($tabel as $key){ ?>
                ['<?php echo $key->tahun; ?>', '<?php echo $key->jumlah; ?>'],
                <?php } ?>
            ]
        };
