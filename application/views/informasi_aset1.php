<div data-bs-parallax-bg="true" class="para-visi-misi p-5">
        <div class="text-center text-white p-5">
            <h1 class="text-center heading-struktur"><strong>LAPORAN APBD</strong><br></h1>
        </div>
    </div>
    <section>
        <div class="container">
    ...
    <section class="mb-5">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div>
                        <h5 class="text-center text-sm-left text-md-left text-lg-left text-xl-left">LAPORAN APBD BPKAD KOTA CIMAHI</h5>
                    </div>
                </div>
                <div class="col-12">
                    <div>
                        <h5><span class="mr-2"><i class="far fa-file-pdf"></i></span><strong>Laporan APBD</strong></h5>
                    </div>
                </div>
                <div class="col-12">
                    <div>
