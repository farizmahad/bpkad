            ...
            <div class="content">
                <table class="main" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <?php foreach($detail_kontak as $de) :?>
                            <table  cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <img class="img-responsive" src="http://bursasajadah.com/header_email.jpg">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="content-block">
                                        <h3><hr> Terimakasih <?php echo $de->nama; ?> telah menghubungi BPKAD Cimahi</h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        Anda telah mengirim pesan kepada BPKAD Cimahi pada tanggal <?php echo $de->tanggal; ?>
                                        dengan <b>pesan</b>
                                        <br>
                                        <i><?php echo $de->pesan_kontak; ?></i>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                        Untuk jawaban pertanyaan anda adalah
                                        <br>
                                        <i><?php echo $de->pesan_balasan; ?></i>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                     Jika anda kurang puas dengan jawaban kami silakan hubungi (022) 665-4274
                                </tr>
                              </table>
                        </td>
                    </tr>
