            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Jenis Rancangan Belanja Daerah    </h5>               &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  <button type="button" class="btn btn-sm btn-outline btn-info" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i></button>
...
<td align="center"><button type="button" class="btn btn-sm btn-outline btn-info btn-sm edit_button" 
                                ...
                                data-id_jenis_rbd="<?php echo $kow->id_jenis_rbd; ?>"
        ...
        <i class="fa fa-pencil"></i>
                                    ...
                                    <a href="#" data-url="<?php echo site_url('admin/Keuangan/delete_jenis_rbd/'.$kow->id_jenis_rbd);?>" class="btn btn-sm btn-outline btn-success btn-sm confirm_delete"><i class="glyphicon glyphicon-trash"></i></a>
                                    </td>
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                               ...
                               <td align="center">
                                ...
                                data-id_rbd="<?php echo $suw->id_rbd; ?>"
                                data-tahun="<?php echo $suw->tahun;?>"
data-jumlah="<?php echo $suw->jumlah;?>"
data-id_jenis_rbd="<?php echo $suw->id_jenis_rbd;?>"
                                >
        <i class="fa fa-pencil"></i>
                                    ...
                                    <a href="#" data-url="<?php echo site_url('admin/Keuangan/delete_rbd/'.$suw->id_rbd);?>" class="btn btn-sm btn-outline btn-success btn-sm confirm_delete1"><i class="glyphicon glyphicon-trash"></i></a>
                               </td>
                            </tr>
                          <?php endforeach; ?>
                            </tbody>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo base_url();?>admin/Keuangan/save_jenis_rbd">
          <div class="form-group">
            <label>Jenis sumber </label>
            <input type="text" class="form-control" name="jenis_sumber" placeholder="Jenis Rencana Belanja Daerah" required oninvalid="this.setCustomValidity('Kategori Berita harus diisi')" oninput="setCustomValidity('')">
          </div>
...
<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo base_url();?>admin/Keuangan/save_rbd">
        <div class="form-group">
            <label>Tahun </label>
...
?>
          ...
          <div class="form-group">
            <label>Jenis  </label>
            <select name="id_jenis_rbd" class="form-control">
           <option value="">Jenis</option>
             <?php foreach($epd as $mow) : ?>

               <option value="<?php echo $mow->id_jenis_rbd; ?>"><?php echo $mow->jenis; ?></option>
             <?php endforeach; ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo base_url();?>admin/Keuangan/save_jenis_rbd">
          <div class="form-group">
            <label>Jenis Sumber</label>
            <input type="text" class="form-control jenis" name="jenis_sumber" placeholder="Jenis Estimasi Daerah" required oninvalid="this.setCustomValidity('Jenis Estimasi  harus diisi')" oninput="setCustomValidity('')">
          </div>
          
           <input class="form-control id_jenis_rbd" type="hidden" name="id">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-sm btn-default" data-dismiss="modal"> <i class="fa fa-close"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tutup&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
        <button type="submit" class="btn btn-sm btn-primary"> <i class="fa fa-save"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Simpan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
...
<div class="modal fade" id="EditModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Form Edit Rencana Belanja Daerah</h4>
      </div>
      <div class="modal-body">
        <form method="post" action="<?php echo base_url();?>admin/Keuangan/save_rbd">
        <div class="form-group">
...
?>
          ...
          <div class="form-group">
            <label>Jenis  </label>
            <select name="id_jenis_rbd" class="form-control id_jenis_rbd">
           <option value="">Jenis</option>
             <?php foreach($epd as $mow) : ?>
...
<input class="form-control id_rbd" type="hidden" name="id">
          </div>
...
$(document).on( "click", '.edit_button',function(e) {
    var id_jenis_rbd = $(this).data('id_jenis_rbd');
    var jenis = $(this).data('jenis');


    $(".id_jenis_rbd").val(id_jenis_rbd);
    $(".jenis").val(jenis);
