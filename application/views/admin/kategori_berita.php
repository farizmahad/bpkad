<div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                <h2>Kategori Berita  
                 ...
                 <a href="<?php echo base_url(); ?>admin/Kategori_berita"><button type="button" class="btn btn-sm btn-white" data-toggle="modal"><i class="fa fa-refresh"></i> Refresh</button></a>
            </div>
        </div>
              ...
              <br>
                    ...
                    <div class="input-group">
                      ...
                      <select name="kategori" class="chosen-select form-control target">
                        ...
                        <option value="">Cari berdasarkan nama kategori</option>
                      <?php foreach($kategori as $ros) : ?>
                                            <option value="<?php echo $ros->id_kategori_berita; ?>"><?php echo $ros->kategori; ?></option>
...
<?php
                            ...
                            foreach($kategori_berita  as $row): ?>
                                ...
                                data-id="<?php echo $row->id_kategori_berita; ?>"
        ...
        <i class="fa fa-pencil"></i>
                                &nbsp;&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <a href="#" data-url="<?php echo site_url('admin/Kategori_berita/delete_kategori/'.$row->id_kategori_berita);?>" class="btn btn-sm btn-success btn-sm confirm_delete"><i class="glyphicon glyphicon-trash"></i>&nbsp;&nbsp;&nbsp;Hapus&nbsp;&nbsp;&nbsp;</a>
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo base_url();?>admin/Kategori_berita/save_kategori">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="nama_kategori" placeholder="Kategori" required oninvalid="this.setCustomValidity('Kategori Berita harus diisi')" oninput="setCustomValidity('')">
          </div>
