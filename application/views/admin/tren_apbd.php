        ...
        <div class="wrapper wrapper-content animated fadeInRight ecommerce">
           <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="<?php echo base_url();?>admin/APBD/upload_trend_apbd" class="dropzone" id="dropzoneForm" enctype="multipart/form-data">
                                            <div class="fallback">
                                                <input name="file" type="file">
                                            </div>
                                        </form> 
              <br><?php echo $this->session->flashdata('message');?><br>
              <a href="<?php echo base_url(); ?>admin/APBD/tren_apbd"> <button type="button" class="btn btn-block  btn-info"><b>Refresh</b></button></a>
              <br><br>
                        <div class="table-responsive">
                            <form method="get" action="<?php echo base_url();?>admin/APBD/tren_apbd">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="example2">
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a href="#" data-url="<?php echo site_url('admin/APBD/delete_tren_apbd/'.$per->id_tren);?>" class="btn btn-sm btn-success btn-sm confirm_delete"><i class="glyphicon glyphicon-trash"></i>&nbsp;&nbsp;&nbsp;Hapus&nbsp;&nbsp;&nbsp;</a>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Form Edit Trend APBD</h4>
                        </div>
                        <div class="modal-body">
                            <form method="post" action="<?php echo base_url();?>admin/APBD/edit_tren_apbd">
                                <div class="form-group">
                                ...
                                <input class="form-control id_tren" type="hidden" name="id">
                        </div>
