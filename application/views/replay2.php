  ...
  <div class="row justify-content-center mt-3 mb-3">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
          <?php if(($jumlah_4 > 0) or ($jumlah_5 > 0) or ($jumlah_6 > 0)) {?>
            ...
            <h5><strong>VISUALISASI APBD BPKAD KOTA CIMAHI TAHUN <?php echo $tahun; ?> <?php echo strtoupper($type); ?></strong></h5>
            <?php }else{ ?>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="text-center">
                        <h5><strong>
                             ...
                             <?php if(($jumlah_4 > 0) or ($jumlah_5 > 0) or ($jumlah_6 > 0)) {?>
            <div class="text-center">
            <h5><strong>VISUALISASI PENDAPATAN APBD BPKAD KOTA CIMAHI TAHUN <?php echo $tahun; ?> <?php echo strtoupper($type); ?></strong></h5>
            <?php }else{ ?>
            ...
            <div class="text-center">
            <h5><strong>VISUALISASI BELANJA APBD BPKAD KOTA CIMAHI TAHUN <?php echo $tahun; ?> <?php echo strtoupper($type); ?></strong></h5>
            <?php }else{ ?>
            ...
            <div class="text-center">
            VISUALISASI PEMBIAYAAN APBD BPKAD KOTA CIMAHI TAHUN <?php echo $tahun; ?> <?php echo strtoupper($type); ?></strong></h5>
            <?php }else{ ?>

             TIDAK ADA DATA!</strong></h5>
            <?php } ?>
                        </strong><br></h5>
                    </div>
                </div>
