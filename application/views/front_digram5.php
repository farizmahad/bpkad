    ...
    <div class="container">
        ...
        <div class="row text-center" style="padding-bottom:30px;">
            ...
            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4" data-aos="fade-up" data-aos-delay="200">
                ...
                <?php echo $type; ?>
                <canvas id="doughnutChart21" width="350" height="350" style="margin: 18px auto 0"></canvas>
                <br>
            ...
            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4" data-aos="fade-up" data-aos-delay="200">
                ...
                <canvas id="doughnutChart22" width="350" height="350" style="margin: 18px auto 0"></canvas>
                <br>
            ...
            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4" data-aos="fade-up" data-aos-delay="200">
                ...
                <canvas id="doughnutChart23" width="350" height="350" style="margin: 18px auto 0"></canvas>
                <h5>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var ctx4 = document.getElementById("doughnutChart21").getContext("2d");
        ...
        var ctx4 = document.getElementById("doughnutChart22").getContext("2d");
        new Chart(ctx4, {type: 'doughnut', data: doughnutData, options:doughnutOptions});
        ...
        var ctx5 = document.getElementById("doughnutChart23").getContext("2d");
