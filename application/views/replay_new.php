...
Highcharts.chart('container5', {
 ...
 $dalam_persen41=round(($p411->jumlah/$jumlah_41*100),2);
                    ...
                    ?>
 {name:'<?php echo $p411->nomor_urut; ?> <?php echo $p411->uraian; ?>',y: <?php echo $dalam_persen41; ?>},
                <?php } ?>
...
Highcharts.chart('container6', {
    ...
    series: [{
        ...
        <?php
                ...
                ?>
 {name:'<?php echo $p42->nomor_urut; ?> <?php echo $p42->uraian; ?>',y: <?php echo $dalam_persen42; ?>},
                <?php } ?>
...
Highcharts.chart('container7', {
    ...
    title: {
        text: 'LAIN-LAIN PENDAPATAN DAERAH YANG SAH <?php echo strtoupper($type); ?> <?php echo $tahun; ?>'
    },
    tooltip: {
        pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
    },
    ...
    series: [{
        ...
        <?php
               ...
               $no=0;
                ...
                $dalam_persen43=round(($p43->jumlah/$jumlah_43*100),2);
               ?>
 {name:'<?php echo $p43->nomor_urut; ?> <?php echo $p43->uraian; ?>',y: <?php echo $dalam_persen43; ?>},
                <?php } ?>
...
Highcharts.chart('container8', {
 ...
 {name:'4.1 Pendapatan Asli Daerah',y:  <?php echo $persen41; ?>},
                
{name:'4.2 Dana Perimbangan',y:  <?php echo $persen42; ?>},
     {name:'4.3 Lain-lain pendapatan yang sah',y:  <?php echo $persen43; ?> }       
...
Highcharts.chart('container9', {
 ...
 {name:'5.1 Belanja Tidak Langsung',y:  <?php echo $persen51; ?>},
                
{name:'5.2 Belanja Langsung',y:  <?php echo $persen52; ?>},
...
Highcharts.chart('container10', {
 ...
 {name:'6.1 Penerimaan Pembiayaan Daerah',y:  <?php echo $persen61; ?>},
                
{name:'6.2 Pengeluaran Pembiayaan Daerah',y:  <?php echo $persen62; ?>},
...
Highcharts.chart('container11', {
    ...
    title: {
        text: 'BELANJA TIDAK LANGSUNG <?php echo strtoupper($type); ?> <?php echo $tahun; ?>'
    },
    tooltip: {
        pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
    },
    ...
    series: [{
       ...
       <?php
                ...
                ?>
 {name:'<?php echo $b51->nomor_urut; ?> <?php echo $b51->uraian; ?>',y: <?php echo $dalam_persen51; ?>},
                <?php } ?>
...
Highcharts.chart('container12', {
    ...
    title: {
        text: 'BELANJA LANGSUNG <?php echo strtoupper($type); ?> <?php echo $tahun; ?>'
    },
    tooltip: {
        pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
    },
    ...
    series: [{
        ...
        <?php
                ...
                ?>
 {name:'<?php echo $b52->nomor_urut; ?> <?php echo $b52->uraian; ?>',y: <?php echo $dalam_persen52; ?>},
                <?php } ?>
...
Highcharts.chart('container13', {
    ...
    title: {
        text: 'PENERIMAAN PEMBIAYAAN DAERAH <?php echo strtoupper($type); ?> <?php echo $tahun; ?>'
    },
    tooltip: {
        pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
    },
 ...
 {name:'<?php echo $p61->nomor_urut; ?> <?php echo $p61->uraian; ?>',y: <?php echo $dalam_persen61; ?>},
                <?php } ?>
...
Highcharts.chart('container14', {
    ...
    title: {
        text: 'PENGELUARAN PEMBIAYAAN DAERAH <?php echo strtoupper($type); ?> <?php echo $tahun; ?>'
    },
    tooltip: {
        pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
    },
 ...
 {name:'<?php echo $p62->nomor_urut; ?> <?php echo $p62->uraian; ?>',y: <?php echo $dalam_persen62; ?>},
                <?php } ?>
